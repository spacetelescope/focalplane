...
PACKAGENAME = metadata.get('package_name', 'focalplane')
DESCRIPTION = metadata.get('description', 'Tools for focal plane geometric calibration of astronomical telescopes.')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: focalplane requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
